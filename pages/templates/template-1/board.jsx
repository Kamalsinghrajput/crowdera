  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Meet all the board members of Charifund — leaders driving change and impact worldwide."
        />
      ...
      <main>
        {/* Banner */}
        <section className="bg-[#091F1B] pt-36 pb-16 relative overflow-hidden">
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-0 right-0 w-96 h-96 bg-[rgba(0,113,93,0.10)] rounded-full blur-3xl translate-x-1/2 -translate-y-1/2" />
            <div className="absolute bottom-0 left-0 w-72 h-72 bg-[rgba(255,202,8,0.08)] rounded-full blur-3xl -translate-x-1/3 translate-y-1/3" />
          </div>
          <div className="container mx-auto px-4 max-w-7xl relative z-10">
            <Link href="/templates/template-1">
              <a className="inline-flex items-center gap-2 text-[var(--primary)] hover:text-white transition-colors text-sm font-semibold mb-4">
                <ArrowLeft size={16} /> Back to Home
              </a>
            </Link>
            <span className="text-[var(--primary)] font-bold tracking-widest uppercase text-sm block mb-3">
              Leadership
            </span>
            <h1 className="text-4xl md:text-6xl font-extrabold text-white leading-tight">
              Our Board <span className="text-[var(--primary)]">Members</span>
            </h1>
            <p className="text-gray-400 mt-4 max-w-2xl text-lg">
              Meet the visionary leaders steering Charifund's mission to create
                ...
                <div key={idx} className="group">
                  <div className="relative overflow-hidden rounded-2xl shadow-lg bg-gray-100">
                    ...
                    <div className="absolute bottom-4 right-4 z-10 group/btn">
                      <div
                        className="absolute bottom-10 right-0 pb-2 flex flex-col gap-2
                      ...
                      <button className="w-10 h-10 rounded-full bg-[var(--primary)] text-[#091F1B] flex items-center justify-center shadow-lg hover:bg-[var(--secondary)] hover:text-white transition-colors hover:scale-110 transform">
