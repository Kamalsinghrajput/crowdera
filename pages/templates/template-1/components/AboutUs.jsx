...
const AboutUs = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="w-4 h-4 rounded-full bg-brand-teal absolute"
          style={{ top: 0, left: 0 }}
        ></div>
        <div
          className="w-2.5 h-2.5 rounded-full bg-brand-yellow absolute"
            ...
            <ul className="space-y-4 mb-10">
              {[
                ...
                <li key={i} className="flex items-start">
                  <CheckCircle2
                    className="text-brand-teal mt-1 mr-3 min-w-[24px]"
                    size={24}
                  />
