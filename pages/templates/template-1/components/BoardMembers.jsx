      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          {members.map((m, idx) => (
            <div key={idx} className="member-card opacity-0 group">
              ...
              <div className="mt-4 text-center">
                <h4 className="text-lg font-extrabold text-brand-dark group-hover:text-brand-teal transition-colors">
                  {m.name}
                </h4>
        ...
        <div className="text-center mt-12">
          <Link href="/templates/template-1/board">
            <a
              className="inline-flex items-center gap-2 bg-brand-dark text-white font-bold py-4 px-10 rounded-full
