      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
                ...
                >
                  <div className="relative h-44 overflow-hidden">
                    ...
                    <div className="absolute bottom-3 left-3 right-3 z-10">
                      ...
                      <span className="bg-brand-yellow text-brand-dark text-[10px] font-bold py-0.5 px-2.5 rounded-full">
                        {c.tag}
                      </span>
                    </div>
                  </div>
        ...
        <div className="text-center mt-6">
          <Link href="/templates/template-1/campaigns">
            <a
              className="inline-flex items-center text-brand-teal font-bold text-sm hover:text-brand-dark transition-colors group"
              style={{
                color: "#FFCA08",
