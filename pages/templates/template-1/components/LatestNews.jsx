...
const LatestNews = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="w-3 h-3 rounded-full bg-brand-teal absolute"
          style={{ top: 0, left: 0 }}
        ></div>
        <div
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        <div className="text-center mb-14">
          ...
          <h2 className="text-3xl lg:text-5xl font-extrabold text-brand-dark leading-tight">
            Our Latest <span className="text-brand-teal">News</span> &amp;
            Articles
            <br />
            You Like
          </h2>
              ...
              <div className="p-5 pt-4">
                ...
                <div className="flex items-center text-xs text-gray-400 mb-3 space-x-4">
                  ...
                  <span className="flex items-center">
                    <MessageCircle
                      size={13}
                      className="mr-1 text-brand-yellow"
                    />
                ...
                <a
                  href="#"
                  className="inline-flex items-center text-sm font-bold text-brand-dark hover:text-brand-teal transition-colors group/link"
                >
                  Read More
        ...
        <div className="text-center mt-12">
          <a
            href="#"
            className="inline-flex items-center bg-brand-dark text-white font-bold text-sm py-3.5 px-8 rounded-md hover:bg-brand-teal transition-all group shadow-lg"
          >
            View All
            <ArrowUpRight
              size={15}
