        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {causes.map((cause, idx) => {
            ...
            return (
              <div
                key={idx}
                className="cause-card opacity-0 bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow group flex flex-col"
              >
                ...
                <div className="p-8 flex-grow flex flex-col">
                  <h3 className="text-2xl font-bold text-brand-dark mb-3 hover:text-brand-teal transition-colors cursor-pointer">
                    {cause.title}
                  </h3>
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="flex justify-between text-sm font-bold text-brand-dark mb-6">
                      ...
                      <div>{percentage}%</div>
                      <div>
                        <span className="text-gray-500 font-normal">Goal:</span>{" "}
                    ...
                    <a
                      href="#"
                      className="block text-center w-full bg-gray-50 text-brand-dark border border-gray-200 font-bold py-3 rounded-full hover:bg-brand-yellow hover:border-brand-yellow transition-all"
                    >
                      Donate Now
                    </a>
                  </div>
