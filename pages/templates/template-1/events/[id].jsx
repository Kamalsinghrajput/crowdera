      ...
      <style>{`:root { --primary: ${primaryColor}; --secondary: ${secondaryColor}; }`}</style>
        <div className="text-center">
          ...
          <Link href="/templates/template-1/events">
            <a className="text-[var(--secondary)] font-bold hover:underline">← Back to Events</a>
          </Link>
        </div>
      </div>);
    ...
    <div className="bg-white min-h-screen font-sans">
      ...
      <div className="relative w-full h-[75vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          {/* Event type pill */}
          <span className="inline-flex items-center gap-2 bg-brand-yellow/20 backdrop-blur-sm border border-brand-yellow/40 text-[var(--primary)] text-xs font-bold px-5 py-2 rounded-full mb-6">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            ...
            className="flex items-center gap-3 bg-white/10 backdrop-blur-sm border border-white/20 text-white rounded-2xl px-5 py-3">
                <div className="w-8 h-8 rounded-xl bg-[var(--primary)] flex items-center justify-center text-[#091F1B] shrink-0">
                  {m.icon}
                </div>
      ...
      <div className="container mx-auto px-4 md:px-8 py-12">
        ...
        {/* Back */}
        <Link href="/templates/template-1/events">
          <a className="inline-flex items-center gap-2 text-[var(--secondary)] font-bold mb-8 hover:gap-3 transition-all text-sm">
            <ArrowLeft size={16} /> Back to Events
          </a>
        </Link>

        {/* Fundraiser attribution */}
        <div className="inline-flex items-center gap-2 text-xs border border-gray-200 bg-[#f7f7f7] rounded-full px-4 py-2 mb-10 shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-[0_4px_30px_rgba(0,0,0,0.06)] border border-gray-100">
              <h2 className="flex items-center gap-3 text-xl font-extrabold text-[#091F1B] mb-6">
                <span className="w-9 h-9 rounded-xl bg-[var(--primary)] flex items-center justify-center shrink-0">
                  <Info size={18} className="text-[#091F1B]" />
                </span>
                About the Event
              </h2>
              <div className="space-y-2">
                {ev.about.split('\n').map((line, i) => {
                  ...
                  return (
                    <p key={i} className={`text-sm leading-relaxed ${isHeading ? 'font-extrabold text-[#091F1B] mt-3' : 'text-gray-600'}`}>
                      {line}
                    </p>);
            ...
            {/* Event Location */}
            <div className="bg-white rounded-2xl p-8 shadow-[0_4px_30px_rgba(0,0,0,0.06)] border border-gray-100">
              <h2 className="flex items-center gap-3 text-xl font-extrabold text-[#091F1B] mb-5">
                <span className="w-9 h-9 rounded-xl bg-[var(--primary)] flex items-center justify-center shrink-0">
                  <MapPin size={18} className="text-[#091F1B]" />
                </span>
                Event Location
              </h2>
              <p className="flex items-center gap-2 font-extrabold text-[#091F1B] mb-1">
                <MapPin size={14} className="text-[var(--secondary)]" /> {ev.venue}
              </p>
            ...
            {/* Comments */}
            <div className="bg-white rounded-2xl p-8 shadow-[0_4px_30px_rgba(0,0,0,0.06)] border border-gray-100">
              <h2 className="flex items-center gap-3 text-xl font-extrabold text-[#091F1B]">
                <span className="w-9 h-9 rounded-xl bg-[var(--primary)] flex items-center justify-center shrink-0">
                  <MessageCircle size={18} className="text-[#091F1B]" />
                </span>
                Comments
              </h2>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-[0_4px_30px_rgba(0,0,0,0.06)] border border-gray-100 text-center">
              ...
              <>
                  ...
                  <p className="font-extrabold text-[#091F1B] text-lg">Event is Finished</p>
                  <p className="text-xs text-gray-400 mt-1">Thank you for participating in this event</p>
                </> :

              <>
                  <div className="w-10 h-10 rounded-full bg-[rgba(0,113,93,0.10)] flex items-center justify-center mx-auto mb-3">
                    <Calendar size={22} className="text-[var(--secondary)]" />
                  </div>
                  <p className="font-extrabold text-[#091F1B] text-lg">Event is Upcoming</p>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-[0_4px_30px_rgba(0,0,0,0.06)] border border-gray-100">
              <div className="text-3xl font-extrabold text-[#091F1B] mb-0.5">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 font-bold py-3 rounded-full mb-3 transition-all text-sm
                           bg-[#091F1B] text-white hover:bg-[var(--primary)] hover:text-[#091F1B]
              ...
              <button className="w-full flex items-center justify-center gap-2 border-2 border-[var(--secondary)] text-[var(--secondary)] font-bold py-3 rounded-full hover:bg-[var(--secondary)] hover:text-white transition-all text-sm">
            ...
            {/* Event Details */}
            <div className="bg-white rounded-2xl p-6 shadow-[0_4px_30px_rgba(0,0,0,0.06)] border border-gray-100">
              <h3 className="flex items-center gap-2 font-extrabold text-[#091F1B] mb-4 text-base">
                <Info size={16} className="text-[var(--secondary)]" /> Event Details
              </h3>
              {[
              ...
              map((d, i) =>
              <div key={i} className="bg-[#f7f7f7] rounded-xl px-4 py-3 mb-2">
                  <div className="flex items-center gap-1.5 text-[10px] text-gray-400 font-bold uppercase tracking-wider mb-0.5">
                    <span className="text-[var(--secondary)]">{d.icon}</span> {d.label}
                  </div>
                  <div className="text-sm font-bold text-[#091F1B]">{d.value}</div>
                </div>
              )}
            </div>
            ...
            {/* Organizer */}
            <div className="bg-white rounded-2xl p-6 shadow-[0_4px_30px_rgba(0,0,0,0.06)] border border-gray-100">
              <h3 className="font-extrabold text-[var(--secondary)] mb-4 text-base">Organizer</h3>
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-full bg-[#091F1B] flex items-center justify-center text-[var(--primary)] font-extrabold text-lg shrink-0">
                  {ev.organizer.name.charAt(0)}
                </div>
                <div>
                  <div className="font-bold text-[#091F1B] text-sm">{ev.organizer.name}</div>
            ...
            {/* Beneficiary */}
            <div className="bg-white rounded-2xl p-6 shadow-[0_4px_30px_rgba(0,0,0,0.06)] border border-gray-100">
              <h3 className="font-extrabold text-[var(--secondary)] mb-4 text-base">Beneficiary</h3>
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-full bg-brand-yellow/20 flex items-center justify-center shrink-0">
                  <Heart size={18} className="text-[#091F1B]" />
                </div>
                <span className="font-bold text-[#091F1B] text-sm">{ev.beneficiary}</span>
              </div>
            </div>

            {/* Team Fundraisers */}
            <div className="bg-white rounded-2xl p-6 shadow-[0_4px_30px_rgba(0,0,0,0.06)] border border-gray-100">
              <h3 className="font-extrabold text-[var(--secondary)] mb-4 text-base">Team Fundraisers (1)</h3>
              <div className="flex items-center gap-3 bg-[#f7f7f7] rounded-xl p-3">
                <div className="w-10 h-10 rounded-full bg-brand-dark/10 flex items-center justify-center shrink-0">
                  <Users size={16} className="text-[#091F1B]" />
                </div>
                <div>
                  <div className="font-bold text-[#091F1B] text-sm">{ev.organizer.name}</div>
