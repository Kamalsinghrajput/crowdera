...
import GalleryCarousel from '../../../src/templates/template-1/components/GalleryCarousel';
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      <Head>
        ...
        <meta name="description" content="Template 1 - Next.js charity template using GSAP and Tailwind CSS" />
