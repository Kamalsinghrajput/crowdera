          ...
          <div className="container mx-auto px-4 max-w-7xl relative z-10">
            <div className="flex items-center gap-3 mb-4">
              <Link href="/templates/template-1">
                <a className="inline-flex items-center gap-2 text-[var(--primary)] hover:text-white transition-colors text-sm font-semibold">
                  <ArrowLeft size={16} />
                  Back to Home
                </a>
              </Link>
            </div>
            <span className="text-[var(--primary)] font-bold tracking-widest uppercase text-sm block mb-3">Our Blog</span>
            <h1 className="text-4xl md:text-6xl font-extrabold text-white leading-tight">
              News &amp; <span className="text-[var(--primary)]">Articles</span>
            </h1>
