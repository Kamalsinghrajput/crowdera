...
const donationCategories = [
  {
    ...
    illustration: (
      ...
      >
        ...
        <path
          d="M70 60 L60 80 M100 60 L100 85 M130 60 L140 80"
          stroke="white"
          strokeWidth="3"
          strokeLinecap="round"
        />
  ...
  },
  {
    ...
    illustration: (
      ...
      >
        ...
        <path
          d="M100 35 L100 65 M85 50 L115 50"
          stroke="white"
          strokeWidth="4"
          strokeLinecap="round"
        />
...
export default function DonationsSection() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={contentRef}
        className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-28"
      >
        <div className="grid md:grid-cols-2 gap-12 items-start mb-16">
          ...
          <div>
            ...
            <p className="leading-relaxed mb-8">
              Ultricies lacus turpis tincidunt aliquet. Eget nunc lobortis
              mattis aliquam faucibus purus in. Bibendum est ultricies integer
              quis actor elit sed. Ultrices tincidunt arcu non sodales neque.
            </p>
