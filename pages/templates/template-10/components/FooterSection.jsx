...
export default function FooterSection() {
  return (
    <footer
      ...
      style={{
        background:
          "url('/assets/template-10-footer.svg') center bottom / cover no-repeat, #511F54",
      }}
    >
      {/* Top CTA strip */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="lg:col-span-2">
          <img
            src="/assets/template-10-logo-footer.svg"
            alt="Logo"
        ...
        {/* Our Services */}
        <div>
          <h4 className="text-white font-extrabold text-sm uppercase tracking-widest mb-5">
            Our Services
          </h4>
        ...
        <div>
          ...
          <address className="not-italic flex flex-col gap-3 text-white/50 text-sm">
            ...
            <a
              href="mailto:info@bighearts.com"
              className="hover:text-t10-rose transition-colors"
            >
              info@bighearts.com
            </a>
            <a
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-white/35 text-xs">
          <p>
            Copyright © {new Date().getFullYear()} BigHearts. All Rights
            Reserved.
          </p>
          <div className="flex gap-5">
            <a href="#" className="hover:text-t10-rose transition-colors">
              Terms of use
            </a>
            <a href="#" className="hover:text-t10-rose transition-colors">
              Privacy Policy
