      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="font-black text-gray-800 text-3xl md:text-4xl lg:text-[44px] leading-tight mb-3">
            Our Top <span className="text-t10-rose">Donors</span>
          </h2>
              ...
              >
                ...
                <div className="relative mb-4">
                  <div
                    ...
                    style={{
                      "--tw-ring-color":
                        d.rank <= 3 ? "#e8547a" : "rgba(155,89,182,0.25)",
                    }}
                  >
                    <img
                      src={d.img}
                  ...
                  <div
                    ...
                    style={{
                      background:
                        rankGradients[d.rank] ||
                        "linear-gradient(135deg, #9b59b6, #7C3682)",
                    }}
                  >
