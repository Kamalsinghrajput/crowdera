...
function WorldMapBg() {
  return (
    ...
    >
      {/* North America */}
      <path opacity="0.18" fill="none" stroke="white" strokeWidth="1.2"
      ...
      {/* Latitude lines */}
      <line opacity="0.08" stroke="white" strokeWidth="0.8" x1="0" y1="120" x2="1000" y2="120" />
      <line opacity="0.08" stroke="white" strokeWidth="0.8" x1="0" y1="180" x2="1000" y2="180" />
      <line opacity="0.08" stroke="white" strokeWidth="0.8" x1="0" y1="240" x2="1000" y2="240" />
      <line opacity="0.08" stroke="white" strokeWidth="0.8" x1="0" y1="300" x2="1000" y2="300" />
      <line opacity="0.08" stroke="white" strokeWidth="0.8" x1="0" y1="360" x2="1000" y2="360" />
      {/* Longitude lines */}
      <line opacity="0.08" stroke="white" strokeWidth="0.8" x1="200" y1="0" x2="200" y2="500" />
      <line opacity="0.08" stroke="white" strokeWidth="0.8" x1="400" y1="0" x2="400" y2="500" />
      <line opacity="0.08" stroke="white" strokeWidth="0.8" x1="600" y1="0" x2="600" y2="500" />
      <line opacity="0.08" stroke="white" strokeWidth="0.8" x1="800" y1="0" x2="800" y2="500" />
    </svg>
  );
}
        ...
        >
          ...
          <div className="relative z-10 px-8 md:px-16 py-14 text-white text-center">
            ...
            <p className="uppercase tracking-[0.25em] text-white/70 text-xs font-semibold mb-8">
              To create a world where every life is valued, uplifted, and empowered without barriers.
            </p>
            ...
            {/* Sub-label */}
            <p className="text-xl md:text-2xl font-bold text-white/90 mb-6">Reached</p>
