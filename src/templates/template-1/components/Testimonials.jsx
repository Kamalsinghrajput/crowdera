...
export default function Testimonials() {
  ...
  return (
    ...
    >
      {/* Decorative blobs */}
      <div className="absolute top-0 left-0 w-80 h-80 rounded-full  blur-3xl -translate-x-1/2 -translate-y-1/2 pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-96 h-96 rounded-full  blur-3xl translate-x-1/3 translate-y-1/3 pointer-events-none" />
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-gray-400 max-w-xl mx-auto">
            Real stories from donors, volunteers, and partners who have
            experienced the Charifund difference.
          </p>
        </div>
        ...
        <div className="flex items-center justify-between mt-8">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={goPrev}
              aria-label="Previous"
              className="w-11 h-11 rounded-full border-2 border-white/20 hover:border-[var(--primary)] flex items-center justify-center text-white hover:text-[var(--primary)] transition-all"
            >
              <ChevronLeft size={20} />
            </button>
            <button
              onClick={goNext}
              aria-label="Next"
              className="w-11 h-11 rounded-full bg-[#FEC908] flex items-center justify-center text-[#091F1B] hover:brightness-110 transition-all"
            >
