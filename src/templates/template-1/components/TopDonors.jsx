...
export default function TopDonors() {
  ...
  return (
    ...
    >
      {/* Decorative bg blobs */}
      <div className="absolute top-0 left-0 w-72 h-72 rounded-full bg-[rgba(0,113,93,0.10)] blur-3xl -translate-x-1/2 -translate-y-1/2 pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-96 h-96 rounded-full bg-[rgba(255,202,8,0.08)] blur-3xl translate-x-1/3 translate-y-1/3 pointer-events-none" />
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="text-3xl lg:text-5xl font-extrabold text-white leading-tight mb-3">
            Our Top <span className="text-[var(--primary)]">Donors</span>
          </h2>
            ...
            {donors.map((d, i) => (
              <div
                ...
                className="flex-shrink-0 bg-white/5 hover:bg-white/10 border border-white/10
                           hover:border-[rgba(255,202,8,0.4)] rounded-2xl p-6 flex flex-col items-center
              ...
              >
                ...
                <div className="relative mb-4">
                  <div
                    className="w-20 h-20 rounded-full overflow-hidden ring-4 ring-offset-2 ring-offset-[#091F1B]
        ...
        <div className="flex items-center justify-between mt-8">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={goPrev}
              aria-label="Previous"
              className="w-11 h-11 rounded-full border-2 border-white/20 hover:border-[var(--primary)]
                         flex items-center justify-center text-white hover:text-[var(--primary)] transition-all"
            >
              <ChevronLeft size={20} />
            </button>
            <button
              onClick={goNext}
              aria-label="Next"
              className="w-11 h-11 rounded-full bg-[var(--primary)] flex items-center justify-center
                         text-[#091F1B] hover:brightness-110 transition-all"
            >
