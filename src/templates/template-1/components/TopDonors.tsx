...
export default function TopDonors() {
  ...
  return (
    <section id="top-donors" className="py-20 lg:py-28 bg-brand-dark relative overflow-hidden">
              ...
              >
                ...
                <div className="relative mb-4">
                  <div
                    ...
                    style={{ '--tw-ring-color': d.rank <= 3 ? '#FFCA08' : 'rgba(255,255,255,0.2)' } as React.CSSProperties}
                  >
                  ...
                  <div
                    ...
                    style={{ background: rankColors[d.rank] || 'rgba(255,255,255,0.15)' }}
                  >
                ...
                <div className="flex items-center gap-1.5 mt-2">
                  <Heart size={13} className="text-brand-yellow" fill="currentColor" />
