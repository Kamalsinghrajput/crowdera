...
import { Instagram, Twitter, Facebook, ArrowRight, Plus, Users } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 max-w-xl mx-auto text-sm md:text-base">
            ...
            and responsible stewardship of every donation we receive.
          </p>
        </div>
        ...
        <div
          ...
          <div key={idx} className="group opacity-0">
              ...
              <div className="mt-4 text-center">
                ...
                <p className="text-sm text-gray-400 font-medium mt-0.5">{m.role}</p>
              </div>
            </div>
          )}
        </div>
