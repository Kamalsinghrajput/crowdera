...
const causes = [
{
  ...
  description: "Diam volutpat commodo sed egestas egestas fringilla phasellus.",
  badge: "ANIMALS",
  ...
  <svg viewBox="0 0 300 200" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        ...
        <path d="M70 130 Q80 120 90 130" stroke="#6366F1" strokeWidth="3" fill="none" />
        <rect x="130" y="60" width="120" height="100" fill="#60A5FA" opacity="0.2" rx="5" />
        <text x="180" y="120" fontSize="40" fill="#6366F1" fontWeight="bold" textAnchor="middle">❤️</text>
      </svg>
...
},
{
  ...
  description: "Massa tempor nec feugiat nisl pretium fusce. Sagittis purus amet.",
  badge: "RECYCLING",
  ...
  <svg viewBox="0 0 300 200" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        ...
        <rect x="110" y="80" width="80" height="70" fill="#F59E0B" opacity="0.4" rx="3" />
        <text x="150" y="125" fontSize="50" fill="#D97706" fontWeight="bold" textAnchor="middle">🎓</text>
      </svg>
...
},
{
  ...
  description: "Pretium nibh ipsum consequat nisl. Quam adipiscing vitae proin.",
  badge: "CHARITY",
  ...
  <svg viewBox="0 0 300 200" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        ...
        <rect x="100" y="70" width="100" height="90" fill="#86EFAC" opacity="0.4" rx="5" />
        <polygon points="150,40 180,70 120,70" fill="#22C55E" opacity="0.5" />
        <text x="150" y="120" fontSize="50" fill="#16A34A" fontWeight="bold" textAnchor="middle">🏠</text>
      </svg>
...
},
{
  ...
  description: "Fighting hunger through nutrition programs and food distribution.",
  badge: "FOOD",
  ...
  <svg viewBox="0 0 300 200" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        ...
        <text x="150" y="120" fontSize="50" fill="#D97706" fontWeight="bold" textAnchor="middle">🍽️</text>
      </svg>
...
},
{
  ...
  <svg viewBox="0 0 300 200" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        ...
        <path d="M100 140 Q100 80 120 60 Q130 50 140 70 Q150 40 160 70 Q170 50 180 60 Q200 80 200 140" fill="#99F6E4" opacity="0.5" />
        <rect x="80" y="140" width="140" height="30" fill="#6EE7B7" opacity="0.4" />
        <text x="150" y="120" fontSize="50" fill="#14B8A6" fontWeight="bold" textAnchor="middle">🌳</text>
      </svg>
    ...
    <section
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-4 sm:px-6">
        <div className="text-center mb-12">
          ...
          <p className="max-w-[600px] mx-auto text-gray-500 text-[15px] leading-relaxed">
            Sed libero enim sed faucibus turpis in eu. Bibendum at varius vel pharetra vel turpis nunc eget fringilla ut morbi. Turpis egestas sed tempus urna et pharetra.
          </p>
        </div>
          ...
          <div
            ...
            <div
              ...
              style={{
                ...
                <div className="p-5">
                  {/* Badge */}
                  <div className={`inline-block ${cause.badgeColor} text-white text-xs font-bold px-3 py-1 rounded-full mb-3`}>
                    {cause.badge}
                  </div>
                  ...
                  <div className="text-xs space-y-1">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold text-gray-800">{cause.goal}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Raised:</span>
                      <span className="font-bold text-pink-600">{cause.raised}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">To Go:</span>
                      <span className="font-bold text-pink-600">{cause.toGo}</span>
                    </div>
                  </div>
                </div>
              </div>
