...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    color: "#9b59b6",
    quote:
      "BigHearts gave us the platform to turn our vision into reality. We've reached more lives in one year than we did in five previously.",
  },
  {
    name: "Sara Lin",
    role: "Donor & Advocate",
    ...
    color: "#e67e22",
    quote:
      "Every dollar I donate here has a story behind it. The transparency and impact reports keep me motivated to give more.",
  },
  {
    name: "Mike Johnson",
    ...
    color: "#3498db",
    quote:
      "This platform changed how we run campaigns. The tools are intuitive and the support team is incredible.",
  },
];
...
export default function TestimonialsSection() {
  ...
  return (
    ...
    >
      ...
      {/* Watermark rings */}
      <svg
        className="absolute left-8 top-12 w-32 opacity-[0.06] pointer-events-none animate-float-slow"
        viewBox="0 0 120 120"
      >
        <circle
          cx="60"
      ...
      <svg
        className="absolute right-10 bottom-10 w-24 opacity-[0.06] pointer-events-none animate-float"
        viewBox="0 0 80 80"
      >
        <path
          d="M40 72S8 54 8 34C8 21 14 12 24 15C32 17 37 23 40 30C43 23 48 17 56 15C66 12 72 21 72 34C72 54 40 72 40 72Z"
          fill="#9b59b6"
        />
      </svg>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="testimonials-header">
            ...
            <h2 className="font-black text-gray-800 text-3xl md:text-4xl lg:text-[44px] mb-4 leading-tight">
              What People Say <span className="text-gray-800">About Our</span>{" "}
              <span className="block text-gray-800">Company</span>
            </h2>
            <p className="text-gray-500 text-[17px] leading-relaxed mb-8 max-w-sm">
              Ultrices tincidunt arcu non sodales neque. Purus in volutpat
              consequat mauris nunc tellus rutrum.
            </p>
