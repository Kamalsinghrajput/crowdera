    ...
    <section className="relative p-0 overflow-hidden bg-[var(--bg-color)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="relative min-h-[350px] md:min-h-[480px] overflow-hidden group">
          ...
          />
          <div className="absolute inset-0 bg-[var(--bg-color)]/75 transition-colors duration-500 group-hover:bg-[var(--bg-color)]/85" />
        ...
        <div className="relative min-h-[350px] md:min-h-[480px] overflow-hidden group">
          ...
          <div className="absolute inset-0 bg-[var(--primary)]/40 transition-colors duration-500 group-hover:bg-[var(--primary)]/50 mix-blend-multiply z-[2]" />
