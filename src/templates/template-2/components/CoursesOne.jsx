...
{
  id: 5, title: "Mental Health Outreach and Counseling.", tag: "Medical",
  ...
  raised: "$18,900", goal: "$30,000", percent: 63,
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hovered ? "0 10px 40px rgba(0,0,0,0.12)" : "0 2px 16px rgba(0,0,0,0.06)",
      ...
      <div style={{ position: "relative", overflow: "hidden", height: 230 }}>
        ...
        <div style={{
          ...
          background: "#FFA415", padding: "6px 18px",
      ...
      <div style={{ padding: "24px 26px 26px" }}>
        <h3 style={{
          ...
          color: "#121D18", marginBottom: 12, lineHeight: 1.4
        }}>
          <a href="#" style={{ color: "inherit", textDecoration: "none" }}>{course.title}</a>
        </h3>
        <p style={{ fontFamily: "Sora, sans-serif", fontSize: 15, color: "#6C6E76", lineHeight: 1.6, marginBottom: 20 }}>
          {course.text}
        </p>

        {/* Raised + Goal */}
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 10 }}>
          <span style={{ fontFamily: "Inter, sans-serif", fontWeight: 700, fontSize: 16, color: "#121D18" }}>
            {course.raised} <span style={{ fontFamily: "Sora, sans-serif", fontWeight: 400, fontSize: 13, color: "#6C6E76" }}>Raised</span>
          </span>
          <span style={{ fontFamily: "Inter, sans-serif", fontWeight: 700, fontSize: 16, color: "#121D18" }}>
            {course.goal} <span style={{ fontFamily: "Sora, sans-serif", fontWeight: 400, fontSize: 13, color: "#6C6E76" }}>Goal</span>
          </span>
        </div>

        {/* Progress bar */}
        <div style={{ position: "relative", height: 8, background: "#F0F0F0", borderRadius: 4, overflow: "visible", marginBottom: 24 }}>
          <div style={{
            width: `${course.percent}%`, height: "100%",
        ...
        <a href="#" style={{
          ...
          <span style={{
            padding: "10px 20px", background: "#121D18", color: "#fff",
            fontFamily: "Inter, sans-serif", fontWeight: 600, fontSize: 15,
            transition: "background 0.3s"
          }}>Donate Now</span>
          <span style={{
            width: 44, height: 44, background: "#121D18",
            display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "50%"

          }}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2.5"><path d="M7 17L17 7M17 7H7M17 7v10" /></svg>
          </span>
        </a>
      </div>
    </div>);
...
export default function CoursesOne() {
  ...
  return (
    <section style={{ position: "relative", background: "#F9F9F9", padding: "120px 0", overflow: "hidden" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "380px 1fr", gap: 60, alignItems: "start" }}>
          ...
          <div>
            ...
            <h2 style={{
              ...
              fontSize: "clamp(28px, 3.5vw, 46px)", lineHeight: 1.2,
              color: "#121D18", textAlign: "right", marginBottom: 40
            }}>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <li key={tab}>
                  ...
                  style={{
                    ...
                    padding: "14px 20px", borderRadius: 6, border: "none", cursor: "pointer",
