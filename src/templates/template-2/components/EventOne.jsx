...
export default function EventOne() {
  return (
    <section style={{ background: "#fff", padding: "120px 0 80px", position: "relative" }}>
      <div className="max-w-[1320px] mx-auto px-3">
        ...
        <div style={{ textAlign: "center", marginBottom: 60 }}>
          ...
          <h2 style={{
            ...
            fontSize: "clamp(28px, 4vw, 52px)", lineHeight: 1.2, color: "#121D18"
          }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 30 }}>
          {EVENTS.map((ev, i) =>
          <div key={i} style={{
            display: "flex", gap: 0, background: "#F9F9F9", borderRadius: 12,
            overflow: "hidden", transition: "box-shadow 0.3s"
          }}
          onMouseEnter={(e) => e.currentTarget.style.boxShadow = "0 10px 40px rgba(0,0,0,0.1)"}
          onMouseLeave={(e) => e.currentTarget.style.boxShadow = "none"}>
            
              {/* Image + date badge */}
              <div style={{ position: "relative", width: 220, flexShrink: 0, overflow: "hidden" }}>
                <img src={ev.img} alt={ev.title} style={{ width: "100%", height: "100%", objectFit: "cover", display: "block", transition: "transform 0.5s" }}
              ...
              {/* Content */}
              <div style={{ padding: "28px 28px", display: "flex", flexDirection: "column", justifyContent: "center", gap: 12 }}>
                <h3 style={{ fontFamily: "Inter, sans-serif", fontWeight: 700, fontSize: 20, color: "#121D18", lineHeight: 1.3, margin: 0 }}>
                  <a href="#" style={{ color: "inherit", textDecoration: "none" }}
                onMouseEnter={(e) => e.currentTarget.style.color = "#FFA415"}
                onMouseLeave={(e) => e.currentTarget.style.color = "#121D18"}>
                  {ev.title}</a>
                </h3>
                <p style={{ fontFamily: "Sora, sans-serif", fontSize: 14, color: "#6C6E76", margin: 0 }}>
                  By {ev.by} <span style={{ marginLeft: 12, color: "#FFA415", fontWeight: 600 }}>{ev.time}</span>
                </p>
                <a href="#" style={{
                display: "inline-flex", alignItems: "center", gap: 8,
                fontFamily: "Inter, sans-serif", fontWeight: 700, fontSize: 14,
                color: "#007B39", textDecoration: "none", marginTop: 4,
                transition: "color 0.3s"
              }}
              onMouseEnter={(e) => e.currentTarget.style.color = "#FFA415"}
              onMouseLeave={(e) => e.currentTarget.style.color = "#007B39"}>
