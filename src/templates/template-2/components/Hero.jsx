...
export default function Hero() {
  ...
  return (
    <section style={{ position: "relative", height: "100vh", minHeight: 700, overflow: "hidden", background: "#000" }}>
      {/* Slides */}
      {SLIDES.map((slide, i) =>
      <div
        key={i}
        style={{
          ...
          {/* Dark overlay */}
          <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to right, rgba(0,0,0,0.75) 40%, rgba(0,0,0,0.3))" }} />
          {/* Map texture overlay */}
          <div style={{
      ...
      <div style={{
        ...
        <div style={{ width: 1, height: 80, background: "rgba(255,255,255,0.2)", marginBottom: 20 }} />
      ...
      {/* Slide Content */}
      <div className="max-w-[1320px] mx-auto px-3" style={{ position: "relative", zIndex: 5, height: "100%", display: "flex", alignItems: "center" }}>
        <div style={{ paddingLeft: "clamp(60px, 8vw, 120px)", maxWidth: 800 }}>
          ...
          <>
              ...
              animation: "slideInUp 0.7s ease forwards"
                ...
                <div style={{ width: 9, height: 9, borderRadius: "50%", background: "#FFA415", flexShrink: 0 }} />
                <span style={{
                color: "#FFA415", fontFamily: "Sora, sans-serif", fontWeight: 600,
              ...
              fontSize: "clamp(42px, 6vw, 85px)", lineHeight: 1.12,
              ...
              {/* Text */}
              <p key={`text-${animKey}`} style={{
              color: "rgba(255,255,255,0.8)", fontFamily: "Inter, sans-serif",
              fontSize: "clamp(16px, 1.5vw, 20px)", lineHeight: 1.7,
              marginBottom: 44, whiteSpace: "pre-line",
              ...
              {/* CTA */}
              <div key={`btn-${animKey}`} style={{ animation: "slideInUp 0.7s 0.3s ease both" }}>
                <a href="#" style={{
      ...
      <div style={{
        ...
        <button
          ...
          onClick={() => goTo(i)}
          style={{
            width: current === i ? 30 : 10, height: 10,
