export default function SiteFooter() {
  const quickLinks = ["About Us", "Our Services", "Our Team", "Our Blog", "Contact Us"];
  ...
  return (
    <footer style={{ background: "var(--t2-dark)", position: "relative", overflow: "hidden" }}>
      ...
      {/* Top section */}
      <div style={{ padding: "80px 0 60px", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
        <div className="max-w-[1320px] mx-auto px-3">
          <div style={{ display: "grid", gridTemplateColumns: "4fr 2fr 3fr 3fr", gap: 50 }}>
            {/* About widget */}
            <div>
