    ...
    <section className="py-[100px] bg-white">
      <div className="max-w-[1320px] mx-auto px-3">
        ...
        >
          ...
          <div className="absolute top-[-60px] right-[15%] w-[280px] h-[280px] rounded-full border border-[#FFA415]/10 pointer-events-none" />
          <div className="absolute bottom-[-80px] left-[10%] w-[380px] h-[380px] rounded-full border border-[#FFA415]/10 pointer-events-none" />
          ...
          <div className="relative z-10 px-6 md:px-16 py-[80px] text-center">
            ...
            <Link href={`/templates/template-2/annual-report/${CURRENT_YEAR}`}>
              <a className="inline-flex items-center gap-3 group text-[var(--secondary)] text-[16px] hover:text-white transition-colors duration-300">
                ...
                <span className="w-10 h-10 rounded-full bg-[var(--secondary)] text-white flex items-center justify-center transition-all duration-300 group-hover:bg-white group-hover:text-[#121d18]">
                  <svg
                    width="18"
                    height="18"
                    viewBox="0 0 24 24"
