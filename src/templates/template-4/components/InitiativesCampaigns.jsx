    ...
    <>
      {campaignsList.map((campaignItem) => {
        ...
        return (
          <div
            key={campaignItem.id}
            className="bg-white rounded-[2rem] overflow-hidden hover:shadow-[0_20px_50px_rgba(0,0,0,0.1)] transition-all duration-500 group flex flex-col border border-gray-100 opacity-0"
          >
            ...
            <div className="p-8 flex flex-col flex-grow text-left">
              ...
              <div className="mt-auto space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <button className="bg-white text-[#121D18] font-black py-3 rounded-full text-xs border-2 border-[#121D18] hover:bg-[#121D18] hover:text-white transition-all active:scale-95">
                    View
                  </button>
                </div>
