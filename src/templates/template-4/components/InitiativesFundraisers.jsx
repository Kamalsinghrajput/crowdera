      ...
      {fundraisersList.map((fundraiserItem) => {
        ...
        return (
          <div
            ...
            className="bg-white rounded-[2rem] hover:shadow-[0_20px_50px_rgba(0,0,0,0.1)] transition-all duration-500 group flex flex-col border border-gray-100 opacity-0 p-8 text-left"
          >
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div className="min-w-0">
                <div className="font-bold text-[#121D18] text-xl leading-tight font-sora">
                  {fundraiserItem.name}
                </div>
