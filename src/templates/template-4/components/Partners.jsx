...
const MARQUEE_STYLE = `
  @keyframes partnerScroll4 {
    0%   { transform: translateX(0); }
    100% { transform: translateX(-50%); }
  }
  .partner-track-4 {
    display: inline-flex;
    animation: partnerScroll4 22s linear infinite;
    will-change: transform;
  }
  .partner-track-4:hover { animation-play-state: paused; }
  .partner-item-4 {
    display: inline-flex;
    align-items: center;
    gap: 10px;
  ...
  .partner-track-4:hover .partner-item-4 { opacity: 0.4; }
  .partner-track-4:hover .partner-item-4:hover { opacity: 1; }
  .partner-item-4 .partner-icon { color: rgba(18,29,24,0.52); transition: color 0.25s; }
  .partner-item-4 .partner-name { color: rgba(18,29,24,0.52); transition: color 0.25s; font-size: 20px; font-weight: 700; letter-spacing: 0.02em; white-space: nowrap; }
  .partner-item-4:hover .partner-icon,
  .partner-item-4:hover .partner-name { color: #FFA415; }
`;
...
export default function Partners() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="partner-track-4">
          {doubled.map((p, i) => (
            <div key={i} className="partner-item-4">
