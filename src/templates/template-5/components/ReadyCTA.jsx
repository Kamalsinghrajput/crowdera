...
export default function ReadyCTA() {
  return (
    <section style={{ padding: "120px 0", background: "var(--bg-color)", textAlign: "center" }}>
      <div style={{ maxWidth: "800px", margin: "0 auto", padding: "0 16px" }}>
        {/* Badge */}
        <div style={{ display: "inline-flex", alignItems: "center", gap: "10px", marginBottom: "20px" }}>
          <span style={{ width: "8px", height: "8px", borderRadius: "50%", background: "var(--primary)", display: "inline-block" }} />
          <span style={{ fontSize: "16px", color: "var(--primary)", fontStyle: "italic", fontWeight: 600 }}>Get Involved</span>
        </div>
