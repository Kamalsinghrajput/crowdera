      ...
      >
        ...
        <div className="flex items-center justify-center gap-4 px-2">
          ...
          >
            ...
            <div className="w-12 h-12 rounded-full bg-[var(--bg-color)] flex items-center justify-center cursor-pointer text-white transition group-hover/social:bg-[var(--secondary)]">
              <svg
                width="18"
                height="18"
                viewBox="0 0 24 24"
          ...
          <div style={{ textAlign: "left" }}>
            <h3 className="text-[20px] text-[var(--bg-color)] mb-1 leading-[1.2] font-bold transition group-hover:text-[var(--secondary)]">
              <button
                onClick={openModal}
                className="bg-transparent border-none cursor-pointer text-inherit font-inherit text-left p-0"
              >
                {member.name}
              </button>
            </h3>
            ...
            >
              ...
              >
                {[
                  ...
                  ["Organization", member.organization || "Tamun Foundation"],
