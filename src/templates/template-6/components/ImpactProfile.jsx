...
export default function ImpactProfile() {
  const primaryColor = "#f59e0b"; // Template 6 Orange
            ...
            <div className="flex justify-center">
              ...
              >
                <span className="flex items-center gap-3">
                  ...
                  <span className="w-10 h-10 rounded-full bg-white text-orange-500 flex items-center justify-center transition-all duration-300 group-hover:bg-black group-hover:text-white">
                    <svg
                      width="18"
                      height="18"
                      viewBox="0 0 24 24"
