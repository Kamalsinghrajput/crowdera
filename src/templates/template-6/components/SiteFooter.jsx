...
export default function SiteFooter() {
  const quickLinks = [
    { label: "Home", href: "/templates/template-6" },
    { label: "About Us", href: "/templates/template-6/about" },
    { label: "Campaigns", href: "/templates/template-6/initiatives" },
    { label: "Volunteers", href: "/templates/template-6/team" },
    { label: "Contact Us", href: "/templates/template-6/contact" },
  ];
