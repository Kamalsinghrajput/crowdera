      ...
      <div className="max-w-[1320px] mx-auto px-3">
            ...
            {DONORS.map((d, i) => (
              ...
              >
                ...
                <div className="relative mb-6">
                  <div className="relative w-[100px] h-[100px] rounded-full overflow-hidden border-4 border-white shadow-md">
                    <Image
                      src={d.img}
                      alt={d.name}
                      width={100}
                ...
                {/* Name */}
                <h4 className="text-[20px] text-[var(--bg-color)] mb-2 group-hover:text-[var(--primary)] transition-colors font-bold">
                  {d.name}
                </h4>

                {/* Amount */}
                <div className="flex items-center gap-1.5 mt-2">
                  <span className="text-[22px] text-[var(--primary)] font-bold">
        ...
        <div className="flex items-center justify-between mt-[50px]">
            ...
            {Array.from({ length: MAX_IDX + 1 }).map((_, i) => (
              <button
                ...
                style={{
                  ...
                  height: "10px",
                  background: i === index ? "var(--secondary)" : "rgba(255,255,255,0.3)",
                }}
              />
            ))}
          </div>
          <div className="flex items-center gap-3">
            <button
              onClick={goPrev}
              className="w-[50px] h-[50px] rounded-full border border-white/20 flex items-center justify-center text-white bg-transparent hover:bg-[var(--secondary)] hover:text-black transition-all duration-300"
            >
              <svg
                width="20"
                height="20"
