...
export default function About() {
  ...
  return (
    <section id="about" ref={sectionRef} className="py-[120px] bg-white overflow-hidden font-sans">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 relative about-img pl-6 pb-12">
            ...
            <div className="absolute bottom-0 left-[15%] z-30 bg-white rounded-2xl p-6 shadow-[0_10px_40px_rgba(0,0,0,0.1)] flex flex-col items-center justify-center min-w-[160px]">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-[#005e46] text-[42px] font-bold leading-none">15+</span>
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-6 about-content">
            ...
            <div className="flex flex-col">
              <span className="text-[#007b5e] font-bold text-[15px] mb-3">
            ...
            <p className="text-[#666666] text-[16px] leading-[1.8] m-0">
            ...
            <div className="flex flex-wrap items-center justify-between gap-8 mt-4">
              ...
              <div className="flex items-center gap-6">
                <div className="flex flex-col">
                  <span className="text-black text-[36px] font-bold leading-none mb-1">999+</span>
                  <span className="text-[#777777] text-[14px]">Active Reviews</span>
                </div>
                
                {/* Avatar Group */}
                <div className="flex -space-x-3">
                  {["men/32", "men/46", "women/44", "women/68"].map((img, i) => (
                    <div key={i} className="w-[45px] h-[45px] rounded-full border-2 border-white overflow-hidden shadow-sm relative z-[1]">
                      <Image 
            ...
            <div className="mt-4">
              <Link href="/about">
                <a className="inline-block bg-[#d9a96e] text-black font-bold text-[15px] px-8 py-4 rounded-md transition-colors hover:bg-[#c4965d]">
                  More About Us
                </a>
              </Link>
            </div>
