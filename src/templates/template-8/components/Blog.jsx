      ...
      <div className="max-w-[1200px] mx-auto px-4">
        ...
        {!isAllBlogsPage && (
          <div className="text-center mb-16">
            <span className="text-[var(--primary)] font-bold text-[17px] uppercase tracking-wider mb-3 block">
              OUR BLOG/NEWS
            </span>
            <h2 className="font-extrabold text-[clamp(32px,4vw,46px)] text-[var(--bg-color)] leading-tight max-w-[800px] mx-auto m-0">
