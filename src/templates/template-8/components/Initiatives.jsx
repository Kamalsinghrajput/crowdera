...
const Initiatives = ({ initialTab = "campaigns" }) => {
  ...
  return (
    <section className="bg-white">
      ...
      <div className="bg-[var(--primary)] py-24 lg:py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-[1200px] relative z-10 text-center">
          ...
          <p className="text-white/80 text-lg mb-10 max-w-2xl mx-auto">
            Help us empower communities and create lasting impact through our
            diverse range of campaigns and events.
          </p>
          <div className="max-w-2xl mx-auto relative group">
            ...
            <input
              ...
              className="w-full pl-16 pr-8 py-5 rounded-full bg-white text-gray-900 text-base font-medium shadow-2xl focus:outline-none focus:ring-4 focus:ring-[var(--secondary)]/30 transition-all border-none"
              value={searchQuery}
            ...
            <div className="flex items-center justify-center sm:justify-start gap-10 md:gap-14 border-b border-gray-100 overflow-x-auto no-scrollbar">
              {["campaigns", "events", "fundraisers"].map((tabName) => (
                <button
                  ...
                  className={`pb-5 text-sm font-bold uppercase tracking-widest transition-all relative whitespace-nowrap ${activeTab === tabName ? "text-[var(--primary)]" : "text-gray-400 hover:text-[var(--primary)]"}`}
                >
                  {tabName}
                  {activeTab === tabName && (
                    <div className="absolute bottom-0 left-0 w-full h-1 bg-[var(--secondary)]"></div>
                  )}
                </button>
              ))}
            </div>
            <div className="flex flex-wrap items-center gap-4 justify-center sm:justify-start">
              <div className="relative min-w-[140px]">
                <div
                  ...
                  className={`flex items-center justify-between w-full bg-white border px-5 py-3.5 rounded-full text-sm font-bold text-[#111] transition-all cursor-pointer ${isFilterOpen ? "border-[var(--primary)]" : "border-gray-200 hover:border-[var(--primary)]"}`}
                >
                ...
                {isFilterOpen && (
                  <>
                    ...
                    ></div>
                    <div className="absolute top-full left-0 mt-2 w-64 bg-white rounded-xl shadow-2xl border border-gray-100 p-4 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                      {activeTab === "events" ? (
              ...
              <div className="relative min-w-[160px]">
                ...
                />
                <select
                  className="w-full appearance-none bg-white border border-gray-200 pl-12 pr-10 py-3.5 rounded-full text-sm font-bold text-[#111] focus:outline-none focus:ring-2 focus:ring-[var(--primary)] cursor-pointer"
                  value={category}
              ...
              <div className="relative min-w-[160px]">
                <div className="absolute left-6 top-1/2 -translate-y-1/2 text-[var(--primary)] text-xs font-black">
                  AZ
                </div>
                <select
                  className="w-full appearance-none bg-white border border-gray-200 pl-12 pr-10 py-3.5 rounded-full text-sm font-bold text-[#111] focus:outline-none focus:ring-2 focus:ring-[var(--primary)] cursor-pointer"
              ...
              <button
                onClick={handleReset}
                className="flex items-center justify-center gap-2 px-8 py-3.5 rounded-full bg-gray-50 hover:bg-gray-100 text-[#111] font-bold text-sm transition-all shadow-sm"
              >
                <RefreshCw size={14} />
                <span>Reset</span>
              </button>
