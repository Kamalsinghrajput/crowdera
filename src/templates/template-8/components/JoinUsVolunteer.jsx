...
export default function JoinUsVolunteer() {
  return (
    <section id="join-us-volunteer" className="relative py-[120px] bg-[#091f1b] font-sans overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-4 relative z-10">
        ...
        <div className="bg-white rounded-[24px] shadow-2xl flex flex-col lg:flex-row overflow-hidden w-full">
          ...
          <div className="w-full lg:w-[55%] p-10 lg:p-14 flex flex-col justify-center">
            ...
            {/* Your Donation */}
            <div className="mb-8">
              <h4 className="text-[#091f1b] text-[18px] font-bold mb-4">Your Donation:</h4>
              ...
              <div className="flex items-center bg-[#f4f4f4] rounded-full p-2 mb-4 w-full max-w-[400px]">
                ...
                <input 
                  type="text" 
                  defaultValue="100" 
                  className="bg-transparent border-none outline-none text-[16px] font-bold text-[#333] px-4 w-full"
                />
              </div>
            ...
            <div className="mb-8">
              <h4 className="text-[#091f1b] text-[18px] font-bold mb-4">Select Payment Method</h4>
                ...
                {[
                  ...
                  <label key={method.id} className="flex items-center gap-2 cursor-pointer group">
                    <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center
                      ...
                      {method.checked && <div className="w-2 h-2 rounded-full bg-[#007b5e]"></div>}
                    </div>
                    <span className="text-[#555] text-[14px] font-medium">{method.label}</span>
                  </label>
                ))}
              </div>
            </div>
            ...
            {/* Donate Button */}
            <div>
              <button className="bg-[#d9a96e] hover:bg-[#c4965d] text-black font-bold text-[15px] px-10 py-4 rounded-md transition-colors">
                Donate Now
              </button>
            </div>
